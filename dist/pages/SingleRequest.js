...
exports.SingleRequest = undefined;
...
var SingleRequest = exports.SingleRequest = function (_Component) {
  ...
  function SingleRequest() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SingleRequest.__proto__ || Object.getPrototypeOf(SingleRequest)).call.apply(_ref, [this].concat(args))), _this), _this.logout = function () {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({
    aRequest: _singleRequestAction2.default
  }, dispatch);
};
...
SingleRequest.propTypes = {
  ...
  aRequest: _propTypes2.default.func.isRequired,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SingleRequest);