...
describe('<EditRequest />', function () {
  var wrapper = void 0;
  var props = {
    EditRequestAction: function EditRequestAction() {},
  ...
  it('stores a snapshot of the component', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_editrequest.EditRequest, props));

    expect(wrapper).toMatchSnapshot();
  });
  it('Should check if the wrapper contains instance of editRequest page', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_editrequest.EditRequest, props));
    (0, _chai.expect)(wrapper.instance()).to.be.instanceof(_editrequest.EditRequest);
  });
  ...
  it('Should check if department is supplied on successful editRequest', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_editrequest.EditRequest, props));
  ...
  it('Should check if equipment is supplied on successful editRequest', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_editrequest.EditRequest, props));
    var initialState = wrapper.state();
  ...
  it('Should handle loading on success or error', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_editrequest.EditRequest, _extends({}, props, {
      requestDetail: {
        checkStatus: {
          isLoading: false
        }
