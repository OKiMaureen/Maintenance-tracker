...
describe('<CreateRequest />', function () {
  ...
  it('stores a snapshot of the component', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_AdminCreateRequest.CreateRequest, props));

    expect(wrapper).toMatchSnapshot();
  });
  it('Should check if the wrapper contains instance of CreateRequest page', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_AdminCreateRequest.CreateRequest, props));
    (0, _chai.expect)(wrapper.instance()).to.be.instanceof(_AdminCreateRequest.CreateRequest);
  });
  ...
  it('Should handle loading on success or error', function () {
    wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_AdminCreateRequest.CreateRequest, _extends({}, props, {
      requestDetail: {
        checkStatus: {
          isLoading: false
        }
