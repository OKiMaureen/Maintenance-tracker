...
var _getAllRequestsReducer = require('../../reducers/getAllRequestsReducer');
...
describe('Test all request reducers', function () {
  ...
  it('Should return initial state', function () {
    expect((0, _getAllRequestsReducer2.default)({}, {})).toEqual({});
  });

  it('Should return state of sucessful request gotten', function () {
    var actual = (0, _getAllRequestsReducer2.default)({}, {
